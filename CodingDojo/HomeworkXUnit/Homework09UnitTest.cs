...
namespace HomeworkXUnit
{
    public class Homework09UnitTest
    {
        ...
        public void GetProductsInCartShouldWork(string[] productIdList, IEnumerable<IProduct> expected)
        {
            ...
            IHW.GetProductsInCart().Should().BeEquivalentTo(expected);
        }
        ...
        public static IEnumerable<object[]> ProductsInCartCase => new List<object[]>
        {
            new object[]{
                ...
                new List<Product>{
                    ...
                    new Product { SKU = "p01", Name = "iPad Pro 11-inch", Price = 23900 },
                    new Product { SKU = "p05", Name = "iPhone XS", Price = 23900 },
                }
            },
            new object[]{
